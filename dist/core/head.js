...
import { getBitPath, getHeadPath, getRefHeadsPath, } from "../utils/fileSystem.js";
...
export async function updateHEAD(branchName) {
...
export async function getCurrentHeadHash() {
    ...
    if (!fullHeadPath || !existsSync(fullHeadPath))
        return null;
